...
var rajHandle = require('express-handlebars'); //imported to our var name rajHandle
//must have to import handlebars to our variable which we will register in our source code.
...
app.set('view engine', 'handlebars');//set the view engine to handlebars instead of jade/ejs
...
app.engine('handlebars', rajHandle({defaultLayout:'Rajmain'}));//default layoutfile Rajmain, 
//you can have different different layoutfile as needed (layouts/Rajmain.handlebars)
//app.engine( ) is a function of expressJS
//you have to import the engine (handlebars), //app.engine('handlebars',
// rajHandle() is a constructor, you will call it will return our engine, 
//set engine which by default not supported by expressJs. We have to import it, tatke it function nothing but a constructor, invoke that function which return engine and passing parameters ({defaultLayout:'Rajmain'} 
